...
| Platform | Architecture | Target Artifact Name | Package Format | Integrity Checksum |
| :--- | :--- | :--- | :--- | :--- |
| **Windows** | x86_64 | `the-berry_windows_x64.msi` | Microsoft Installer | `the-berry_windows_x64.msi.sha256` |
| **Windows** | x86_64 | `the-berry_windows_x64.exe` | Standalone Installer / Portable | `the-berry_windows_x64.exe.sha256` |
| **Linux** | x86_64 | `the-berry_linux_x64.AppImage` | Universal AppImage | `the-berry_linux_x64.AppImage.sha256` |
| **Linux** | x86_64 | `the-berry_linux_x64.deb` | Debian / Ubuntu Package | `the-berry_linux_x64.deb.sha256` |
| **macOS** | Apple Silicon (ARM64) | `the-berry_macos_aarch64.dmg` | Apple Disk Image | `the-berry_macos_aarch64.dmg.sha256` |
| **macOS** | Intel (x86_64) | `the-berry_macos_x64.dmg` | Apple Disk Image | `the-berry_macos_x64.dmg.sha256` |

---

## 3. Automated Version Checking, Checksums & Auto-Updates
...
- **SHA-256 Checksum Verification**: Every binary package published through GitHub Actions includes a matching `.sha256` hash manifest for automated integrity verification.
- **Automated Release Notes**: GitHub Actions automatically computes changelogs between tagged versions via `softprops/action-gh-release`.
